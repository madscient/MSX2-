...
private:
	...
	void default_border(const scrntype_t *pens, scrntype_t *ln, scrntype_t* tp);
	void graphic7_border(const scrntype_t *pens, scrntype_t *ln, scrntype_t* tp);
	void graphic5_border(const scrntype_t *pens, scrntype_t *ln, scrntype_t* tp);
	void mode_text1(const scrntype_t *pens, scrntype_t *ln, scrntype_t* tp, int line);
	void mode_text2(const scrntype_t *pens, scrntype_t *ln, scrntype_t* tp, int line);
	void mode_multi(const scrntype_t *pens, scrntype_t *ln, scrntype_t* tp, int line);
	void mode_graphic1(const scrntype_t *pens, scrntype_t *ln, scrntype_t* tp, int line);
	void mode_graphic23(const scrntype_t *pens, scrntype_t *ln, scrntype_t* tp, int line);
	void mode_graphic4(const scrntype_t *pens, scrntype_t *ln, scrntype_t* tp, int line);
	void mode_graphic5(const scrntype_t *pens, scrntype_t *ln, scrntype_t* tp, int line);
	void mode_graphic6(const scrntype_t *pens, scrntype_t *ln, scrntype_t* tp, int line);
	void mode_graphic7(const scrntype_t *pens, scrntype_t *ln, scrntype_t* tp, int line);
...
//  template<typename _PixelType, int _Width> void mode_yjk(const scrntype_t *pens, _PixelType *ln, int line);
	void mode_unknown(const scrntype_t *pens, scrntype_t *ln, scrntype_t* tp, int line);
	void default_draw_sprite(const scrntype_t *pens, scrntype_t *ln, scrntype_t* tp, UINT8 *col);
	void graphic5_draw_sprite(const scrntype_t *pens, scrntype_t *ln, scrntype_t* tp, UINT8 *col);
	void graphic7_draw_sprite(const scrntype_t *pens, scrntype_t *ln, scrntype_t* tp, UINT8 *col);
	...
	{
		UINT8 m;
		void (v99x8_device::*visible_16)(const scrntype_t *, scrntype_t*, scrntype_t*, int);
		void (v99x8_device::*border_16)(const scrntype_t *, scrntype_t*, scrntype_t*);
		void (v99x8_device::*sprites)(int, UINT8*);
		void (v99x8_device::*draw_sprite_16)(const scrntype_t *, scrntype_t*, scrntype_t*, UINT8*);
	} ;
...
private:
	...
	scrntype_t transparent[(512 + 32) * 246 * 2]; // (LONG_WIDTH) * (m_vblank_start*2)
...
public:
	...
	void prepare_screen();
	void draw_screen();
	void draw_line_transparent(scrntype_t* dst, int y);
};
